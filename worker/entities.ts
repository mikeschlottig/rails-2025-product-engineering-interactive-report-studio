...
// BOOKMARK ENTITY: one DO instance per bookmark
export interface Bookmark {
  id: string;
  title: string;
  url?: string;
  note?: string;
  data?: unknown; // For storing things like studio arrangements
  ts: number;
}
export class BookmarkEntity extends IndexedEntity<Bookmark> {
  ...
  static readonly initialState: Bookmark = { id: "", title: "", ts: 0 };
  static seedData = [];
}